-- note: spirv-cross & glslang & slang must require the same vulkan sdk version
-- we use 1.4.309
...
add_requires("slang vulkan-sdk-1.4.309", {configs = { shared = true, debug = is_mode("debug")}, system = false})
add_requires("xxhash")
